...
//         className="  justify-center h-screen w-center ml-2  "
//       >
//         <div className=" flex lg:ml-16 xl:ml-0    ">
//           {/* <motion.div
//             variants={imgVariant}
//             initial="hidden"
//             whileInView="visible"
...
//           {/* md:mr-28 */}
//           {/* md:w-[40%] md:mt-16 */}
//           <div className="absolute md:top-[20vh] lg:top-[20vh] text-center sm:left-52 sm:top-96  top-72  xl:left-[84vh] lg:justify-center text-black  justify-center align-center justify-self-center place-content-center place-items-center md:left-80  ">
//             <motion.div
    ...
    <>
      ...
      >
        <div className=" flex lg:ml-16 xl:ml-0    ">
          ...
          {/* md:mr-28 */}
          {/* md:w-[40%] md:mt-16 */}
          <div className="absolute md:top-[20vh] lg:top-[20vh] text-center sm:left-52 sm:top-96  top-72  xl:left-[84vh] lg:justify-center text-black  justify-center align-center self-center  md:left-80 px-56 ">
            <motion.div
              variants={textVariant2}
              className="text-[24px] md:text-[20px]  lg:text-[32px] xl:text-[32px] "
            >
